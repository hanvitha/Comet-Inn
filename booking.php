...
<html>
<head>
<title>Classic Hotel a Hotel Category Flat Bootstrap Responsive Website Template | Booking :: w3layouts</title>
<!-- for-mobile-apps -->
					...
					<form>
						...
						<div class="dropdown-button">           			
			            	<select class="dropdown" tabindex="10" data-settings='{"wrapperClass":"flat"}'>
									...
									<option value="4">Special Deluxe Room</option>
 							</select>
						</div>
						...
						<button class="btn1 btn-1 btn-1e">RESERVE NOW</button>
					</form>
					<!--strat-date-piker-->
