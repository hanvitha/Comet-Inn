...
<div class ="container">
     ...
     <br/><br/>
     <h3 class="tittle"> <?php echo $_SESSION["sess_name"]?>'s Bookings</h2>
        ...
        <?php 
            try{ 
                ...
                if(true){
                    ...
                    join bookings b
                        on r.room_id = b.room_id and b.user_id ='$user_id'
                        ...
                        while ($row = $result1->fetch_assoc()) { 
                            ...
                            <div class="hotel-rooms">
                                ...
                                <div class="hotel-right">
                                    <h4><p><b>Check In Date:</b> <?php echo "  ".$row['checkin']?></p></h4>
                                    <h4><p><b>Check Out Date:</b> <?php echo "  ".$row['checkout']?></p></h4>
                                    <h4><p><b>Amount Paid:</b> <?php echo "  ".$row['amount_paid']?></p></h4>
                                </div>
                            ...
                            echo "You have not booked any rooms yet! ";
                        }
                    }
                }
                } catch (Exception $e) {
